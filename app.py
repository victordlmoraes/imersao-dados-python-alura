...
# Definie o título da página, o ícone e o layout para ocupar toda a largura
st.set_page_config(
...
# Conteúdo Principal
st.title(":game_die: Dashboard de Salários na Área de Dados")
st.markdown("Explore dados salariais na área de dados nos últimos anos. Utilize os filtros à esquerda para refinar sua análise.")
...
with col_graf3:
    if not df_filtrado.empty:
        ...
        grafico_remoto = px.pie(
            ...
            names='tipo_trabalho',
            values='quantidade',
            title="Prpoporção dos Tipos de Trabalho",
            hole=0.5
        )
...
with col_graf4:
    if not df_filtrado.empty:
        ...
        st.warning("Nenhum dado disponível para exibir o gráfico de países.")
